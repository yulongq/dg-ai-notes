...
diagrams:
  - id: 260702-ch06-two-layer-messages
    ...
    caption: 两层消息——内部结构与 Provider 适配边界
...
<Diagram file="/assets/260702-ch06-two-layer-messages.svg" caption="两层消息——内部结构与 Provider 适配边界" id="260702-ch06-two-layer-messages" />
